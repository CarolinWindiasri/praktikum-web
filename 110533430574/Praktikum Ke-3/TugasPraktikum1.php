<html>
<head> <!-- DOCTYPE berfungsi untuk memudahkan browser untuk menampilkan suatu halaman web dengan benar-->
	<title>Login Page</title> <!-- tag title digunakan untuk menambahkan title bar browser -->
</head>
...
if (isset($_POST['submit'])) {
	if ((isset($_POST['username'])&&$_POST['username']=='carolin')&&(isset($_POST['pass'])&&$_POST['pass']=='olin')) {
